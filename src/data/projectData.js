const projects = [
  ...
  },
  {
    ...
    workImages: [
      "/photos/Crypta/1.jpeg",
      "/photos/Crypta/3.jpeg",
      "/photos/Crypta/2.jpeg",
    ],
  },
  {
    slug: "cms",
  ...
  },
  {
    ...
    role: "Backend Developer",
    tech: "Flutter",
    description: "CMS Armaform is a content management system for Armaform.",
    designPreview: ["/photos/armaform/preview_armaform.png"],
    workImages: [
      "/photos/armaform/1.jpeg",
      "/photos/armaform/3.jpeg",
      "/photos/armaform/2.jpeg",
    ],
  },
  {
    ...
    tech: "Flutter",
    description:
      "AI/IoT salary management system using Flutter with API caching, delivering real-time alerts via cross-platform app adopted by 3+ districts in Central Java. Designed an interactive dashboard to visualize real-time salary data for users and authorities, enhancing situational awareness and response coordination.",
    designPreview: ["/photos/salary-allocator/preview_salary-allocator.png"],
    workImages: [
      "/photos/salary-allocator/1.jpeg",
      "/photos/salary-allocator/3.jpeg",
      "/photos/salary-allocator/2.jpeg",
    ],
  },
  {
    slug: "floodsenseai",
