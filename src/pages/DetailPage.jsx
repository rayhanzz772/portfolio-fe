...
const DetailPage = () => {
  ...
  const pageUrl = `https://rayhancreative.web.id/${categoryPath}/${slug}`;
  ...
  return (
    <>
      ...
      >
        ...
        {content.link && (
          <div className="fixed right-5 md:mr-10 top-4 md:top-1/2 md:-translate-y-1/2 z-50">
            <a
              href={content.link}
              target="_blank"
      ...
      "
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="w-11/12 md:w-9/12 text-left space-y-10"
          >
